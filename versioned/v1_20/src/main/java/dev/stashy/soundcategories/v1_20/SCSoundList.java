    ...
    public static class Entry extends ElementListWidget.Entry<Entry> {
        ...
        public static Entry create(GameOptions gameOptions, int screenWidth, SimpleOption<?>... opts) {
            ...
            for (int i = 0; i < opts.length; i++) {
                ...
                var btn = opts[i].createWidget(gameOptions, (screenWidth - totalWidth) / 2 + layout.x(), 0, layout.width());
                entries.add(btn);
            }
        ...
        public static Entry createGroup(GameOptions gameOptions, int screenWidth, SoundCategory group, ButtonWidget.PressAction settingsPressAction) {
            ...
            var option = gameOptions.getSoundVolumeOption(group);
            return new Entry(
                    List.of(
                            gameOptions.getSoundVolumeOption(group).createWidget(gameOptions, offset, 0, totalWidth - buttonWidth - margin),
